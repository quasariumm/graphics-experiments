//
// DeviceResources.cppm - A wrapper for the Direct3D 12 device and swapchain
//
...
public:
	...
	ID3D12GraphicsCommandList6* GetCommandList() const noexcept { return m_commandList.Get(); }
