...
RaytracedGltfPrimitive::RaytracedGltfPrimitive(DxDevice& device, const std::filesystem::path& modelPath,
	...
	: GltfPrimitive{device, modelPath, asset, primitive, materials}
{
	if (primitive.materialIndex)
		m_materialIndex = static_cast<std::int32_t>(*primitive.materialIndex);
...
void RaytracedGltfPrimitive::AddInstance(const DxDevice& device, Blas& blas, const glm::mat4& transform) const
{
